...
<img src="Results/sim.jpg" alt="Screenshot" width="50%"/>

The designed PWM module was first verified through simulation before FPGA deployment. Using Icarus Verilog as the simulator and GTKWave for waveform visualization, the PWM counter and duty cycle functionality were validated. The output waveforms clearly showed the PWM signal toggling with the expected duty cycle variations, confirming correct register updates and logic behavior.
